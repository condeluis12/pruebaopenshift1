...
public class CDelegacion {
	...
	public String toString (){
		return ("CveDelegacion " + cveDelegacion+ " nomDelegacion " + nomDelegacion + " cveRegion " + cveRegion + "serieIni1 " +serieIni1 +
				" serieFin1 "+ this.serieFin1 + " blocks1 "+ this.cantBlocksDelegacion1 +" serieIni2 " + this.serieIni2 + " serieFin2 "+ 
				this.serieFin2 + " blocks2 "+ this.cantBlocksDelegacion2 + " serieIni3 " +this.serieIni3 + " serieFin3 "+ this.serieFin3 + 
				" blocks3 "+ this.cantBlocksDelegacion3 + " serieIni4 " + this.serieIni4 + " serieFin4 "+ this.serieFin4 + " blocks4 "+ this.cantBlocksDelegacion4);
	}
